...
- **User name** (email): `apple-review@drillfit.com`
...
> DrillFit is a personalized fitness and nutrition tracker. All core
...
- [ ] Created `apple-review@drillfit.com` in Firebase Auth (production project).
